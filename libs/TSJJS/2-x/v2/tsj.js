/*!
   ...
   *19th September 2019 ( 10th Update ( Fix Update )  )
...
tsj.meta = tsj.metadata = function(attributes) {
var rVmeta = tsj.cElement("meta"); for(var key in attributes) { rVmeta.setAttribute(key, attributes[key]); } return rVmeta; document.head.appendChild(this.parentElement) || document.documentElement.appendChild(this.parentElement); }; tsj.title = function(ttl) { return tsj.cElement("title", null, ttl); }; tsj.charset = function(chars) { chars = chars ? chars : "UTF-8"; return tsj.head(" <meta charset='" + chars + "' />"); }; tsj.smartView = function(more) { more = more ? more : " "; return tsj.head(' <meta name="viewport" content="width=device-width, initial-scale=1.0, height=device-height, ' + more  + '" /> '); }; tsj.themeColor = function(clr) { clr = clr ? clr : ""; return tsj.head(" <meta name='theme-color' content='" + clr + "'>"); }; tsj.details = tsj.about = function() { var details = "Project Name : TSJJS <br /> Version : v2 <br /> DOM Types : Real DOM & Fibre DOM <br /> By : Debarchito Nath ( MOD ER HACKS ) <br /> Released On : August 2019 <br /> Released Under : MIT License <br /> Website : https://moderhacks.github.io <br /> Copyright (c) 2019 | ALL RIGHTS RESERVED"; return tsj.docWrite( details ); }; var TSJBunker = function(val) { if ( typeof val === "object" ) { return val; colsole.log("Data type is object, inserting data to bunker resulted success !"); } else if ( typeof val === "array" ) { return val; colsole.log("Data type is array, inserting data to bunker resulted success !"); } else { console.log("ERROR 404 | TSJBunker only excepts data as objects or arrays !"); }; }; var TSJDataStorage  = function(obj) { return TSJBunker(obj); }; Object.prototype.addObjectProperties = Object.prototype.attachObjectProperties = Object.prototype.aObjProps = Object.prototype.objectify = function(key) {
Object.assign(this, key); }; Object.prototype.removeObjectProperties = Object.prototype.rObjProps = Object.prototype.deobjectify = Object.prototype.deObjectify = Object.prototype.detachObjectProperties = function(props, obj) {
obj = obj ? obj: this; for(var i = 0; i < props.length; i++) { if(obj.hasOwnProperty(props[i])) { delete obj[props[i]]; }; }; }; Object.prototype.updateObjectProperties = Object.prototype.uObjProps = Object.prototype.updateObject = Object.prototype.updateObjects = function(key, obj) { obj = obj ? obj: this; obj.addObjectProperties(key); };  Object.prototype.mergeObjects = Object.prototype.mergeObject = Object.prototype.mergeObjectProperties = Object.prototype.mObjProps = function(...obj) {
return Object.assign(this, ...obj); };
Array.prototype.addArrayElement = Array.prototype.aArrElement = Array.prototype.arrayify = function ( item, index, del) { del = del ? del: 0;  return this.splice( index, del, item ); }; Array.prototype.unique = Array.prototype.uniqueArrayElement = function() { var a = this.concat(); for(var i=0; i<a.length; ++i) { for(var j=i+1; j<a.length; ++j) { if(a[i] === a[j]) a.splice(j--, 1); }; }; return a; }; Array.prototype.removeArrayElement = Array.prototype.rArrElement = Array.prototype.deArrayify = Array.prototype.dearrayify = function(num, obj) { obj = obj ? obj: this; delete obj[num]; if ( num === "all" ) { return obj.length = 0; }; }; Object.prototype.stringify = function() { return JSON.stringify( this ); }; Object.prototype.parse = function() { return JSON.parse( this ); };
...
var randomVar_726963 = GETAll(sel); randomVar_726963.onkeypress = clk; }; tsj.addEvent = tsj.aEvent = tsj.aEventListener = tsj.addEventListener = tsj.on = function(sel, evnt, clk) { var randomVar_826963 = GET(sel); randomVar_826963.addEventListener(evnt, clk) || randomVar_826963.attachEvent("on"+evnt, clk); }; tsj.removeEvent = tsj.rEvent = tsj.rEventListener = tsj.removeEventListener = tsj.off = function(sel, evnt, clk) { var event = GET(sel); event.removeEventListener(evnt, clk) || event.detachEvent("on"+evnt, clk); }; 
