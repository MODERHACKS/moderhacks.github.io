...
load.tsjcss = load.TSJCSS = function() { return tsj.head(" <link rel='stylesheet' href='https://moderhacks.github.io/libs/TSJCSS/2-x/v2/tsj.css' /> "); }; load.colorize = load.ColoriZe = function() { return tsj.loadScript("https://moderhacks.github.io/libs/ext/js/ColoriZe/1-x/v1/clz.js", function() { ColoriZe(); }); }; load.tsjmaths = load.TSJMaths = function(func) { return tsj.loadScript("https://moderhacks.github.io/libs/ext/js/TSJMaths/1-x/v1/tm.js", func); }; plugin.tsjanimation = plugin.TSJAnimation = function(func) { return tsj.loadScript("https://moderhacks.github.io/libs/plugins/TSJJS/TSJAnimation/1-x/v1/ta.js", func); }; plugin.tsjstyler = plugin.TSJStyler = function(func) { return tsj.loadScript("https://moderhacks.github.io/libs/plugins/TSJJS/TSJStyler/1-x/v1/ts.js", func); };
